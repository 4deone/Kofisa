...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button ahlogin = (Button) findViewById(R.id.butConnexion);
        progressBar = (ProgressBar) findViewById(R.id.progressBar);
        TextView btnSignIn = (TextView) findViewById(R.id.textViewSignUp);
        button = (SignInButton) findViewById(R.id.googleSignInButton);
